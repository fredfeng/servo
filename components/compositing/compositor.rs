...
use webrender_api::{
    self, DeviceIntPoint, DevicePoint, FramebufferIntSize, HitTestFlags,
    HitTestResult,
};
    ...
    fn composite_specific_target(
        ...
        profile(
            ...
            || {
                ...
                self.window.gl().scissor(viewport.origin.x, viewport.origin.y, viewport.size.width, viewport.size.height);
